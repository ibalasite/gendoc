...
順序與 `templates/pipeline.json` 一致（唯一順序來源）。
...
STEP_SEQUENCE = {
  ...
  "D02-BRD":          "BRD.md 生成",
  "D03-PRD":          "PRD 生成",
  "D04-PDD":          "PDD 生成（client_type != api-only）",
  "D05-VDD":          "VDD 視覺設計文件生成（client_type != api-only）",
  # 設計層
  "D06-EDD":          "EDD 生成",
  "D07-ARCH":         "ARCH 架構文件生成",
  "D07b-UML":         "UML 圖表生成（gendoc-gen-diagrams，特殊步驟）",
  "D08-API":          "API 設計文件生成",
  "D09-SCHEMA":       "Schema 設計文件生成",
  "D10-FRONTEND":     "FRONTEND 前端技術設計生成（client_type != api-only）",
  ...
  "D12b-BDD-client":  "Client BDD Feature Files 生成（client_type != api-only）",
...
D01-IDEA、D02-BRD、D03-PRD、D04-PDD、D05-VDD、D06-EDD、D07-ARCH、D08-API、D09-SCHEMA、D10-FRONTEND、D10b-AUDIO、D10c-ANIM、D11-test-plan、D12-BDD-server、D12b-BDD-client、D13-RTM、D14-runbook、D15-LOCAL_DEPLOY
